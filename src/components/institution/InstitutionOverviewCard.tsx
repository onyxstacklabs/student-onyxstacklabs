...
export function InstitutionOverviewCard() {
  ...
  if (!details) {
    return (
      <div className="p-6 bg-surface-raised border border-surface-border rounded-card">
  ...
  return (
    <div className="bg-surface-raised/80 border border-surface-border rounded-card p-6 sm:p-8 space-y-6">
      ...
      {studentsError && (
        <div className="p-3 bg-accent-danger/10 border border-accent-danger text-accent-danger text-xs rounded-lg">
          {studentsError}
        </div>
      )}

      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="p-4 bg-surface-base border border-surface-border rounded-xl space-y-1">
        ...
        <button
          ...
          className="p-4 bg-surface-base border border-surface-border hover:border-brand-500/40 rounded-xl space-y-1 text-left transition col-span-2 sm:col-span-1"
        >
          <p className="text-[10px] font-mono text-slate-500 uppercase flex items-center gap-1">
        ...
        <div className="p-4 bg-surface-base border border-surface-border rounded-xl space-y-2 col-span-2 sm:col-span-1">
              ...
              {students.map((s) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="text-xs text-brand-400 font-mono">{s.className}</p>
